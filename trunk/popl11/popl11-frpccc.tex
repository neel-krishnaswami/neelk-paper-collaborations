...
\> \;\;\= $\unready{\theta}{S_R(\term{r})} \implies \Ref^{d'}_A(\head{V^R_L(r)}, \term{r}, \mu, \Delta_R(S_R(\term{r})))$ and \Newline
\> \> $\ready{\theta}{S_R(\term{r})}{-} \implies $(\=$\Ref^{d'}_A(\head{\tail{V^R_L(r)}}, \term{r}, \mu, \Delta_R(S_R(\term{r})))$ \Newline
