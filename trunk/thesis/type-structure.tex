...
continuation monad and the state monad via a domain which looks a bit
...
\item If $\judgeE[\Theta, \alpha:\kappa]{\Gamma}{e}{A}$, then 
       $\interpE{\judgeE[\Theta, \alpha:\kappa]{\Gamma}{e}{A}}\;(\theta,[\theta(\tau)])\;\gamma$ =
       $\interpE{\judgeE{[\tau/\alpha]\Gamma}{[\tau/\alpha]e}{[\tau/\alpha]A}}\;\theta\;\gamma$
\item If $\judgeE[\Theta, \alpha:\kappa]{\Gamma}{e}{A}$, then 
       $\interpC{\judgeC[\Theta, \alpha:\kappa]{\Gamma}{c}{A}}\;(\theta,[\theta(\tau)])\;\gamma$ =
       $\interpC{\judgeC{[\tau/\alpha]\Gamma}{[\tau/\alpha]c}{[\tau/\alpha]A}}\;\theta\;\gamma$
\end{itemize}
\end{lemma}
