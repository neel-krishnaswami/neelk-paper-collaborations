...
\oooo Since we continue to know that $\ufcontains{\phi}{u}{v}$, we know $v$ remains maximal in $f'$ \\
\oooo Therefore, due to path compression, $[f'|u:v]^+$ is a strict partial order \\
