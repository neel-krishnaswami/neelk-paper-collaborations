...
\newcommand{\validS}[2][\Delta]{{#1} \vartriangleright {#2} : \spectype \;\mathsf{valid}}
\newcommand{\validP}[2][\Delta]{{#1} \vartriangleright {#2} : \assert \;\mathsf{valid}}
...
\newcommand{\judgeEqA}[4][\Delta]{{#1} \vartriangleright {#2} \equiv {#3} : {#4}}
...
\newcommand{\satisfies}[2]{satisfies({#1}, {#2})}
