...
\newcommand{\judgeS}[2][\Delta]{{#1} \vdash {#2} : \spectype}
...
\newcommand{\judgeACtx}[1]{\vdash {#1} \;\ctext{ok}}
\newcommand{\judgeA}[3][\Delta]{{#1} \vdash {#2} : {#3}}
\newcommand{\judgeSort}[2][\Delta]{\judgeA[{#1}]{{#2}}{\ctext{sort}}}
\newcommand{\judgeSortEq}[3][\Delta]{{#1} \vdash {#2} \equiv {#3} : \ctext{sort}}
