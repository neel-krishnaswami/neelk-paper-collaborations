...
adjusted. \citet{carlsson} showed how to build a monadic combinator
library for self-adjusting computation, using techniques with striking
similarities to the monadic library described in this paper. This lets
us hope that ramifications may help in verifying implementations of
this technique.
