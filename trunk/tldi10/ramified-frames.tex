...
each observer. For a chain of observers only one level deep, this
...
system.  The work by \citet{shaner-leavens-naumann} is also
non-modular, since it requires knowing what all of the observers are.
\texttt{[TODO: add explanation of Barnett and Naumann]}
