...
(* $Id: SetoidList.v,v 1.2 2008-03-17 15:45:27 aleks Exp $ *)
...
Proof.
 ...
 constructor; eauto. intro. apply H0.
 rewrite -> InA_app_iff  in H. rewrite -> InA_app_iff. rewrite InA_cons. intuition.
Qed.
...
Proof.
 ...
 red; destruct 1.
 apply H0.
 rewrite -> InA_app_iff in H0; rewrite -> InA_app_iff in H; rewrite -> InA_app_iff; rewrite -> InA_cons; auto.
 apply H; auto.
...
Proof.
 ...
 split; intros.
 assert (~eqA a x).
  intro. apply H3; apply InA_eqA with a; auto.
 assert (~eqA a y).
  intro; apply H8; eauto.
 intuition.
