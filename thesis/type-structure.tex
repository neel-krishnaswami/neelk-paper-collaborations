...
equations for monotypes, polytypes, and heaps, suitably parameterized
...
which separate the positive and negative occurences of the basic 
continuations. 
...
mono-kinded type constructors to a CPO.  As before, we parameterize by
...
(Though our model supports it, we will never actually use the possibily
