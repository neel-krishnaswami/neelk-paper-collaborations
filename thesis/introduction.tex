...
%Furthermore, the
%specification in chapter 6 relies essentially on the ability to work
%compositionally with higher-order programs, without having to
%defunctionalize a whole program.
