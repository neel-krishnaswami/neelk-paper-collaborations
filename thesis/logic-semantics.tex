...
we'll proceed in stages. First, we'll show how to interpret sorts and
...
\begin{mathpar}
  \inferrule*{ }
             {\judgeS{\spec{p}{c}{a:A}{q} \specimp \mspec{p}{\monad{c}}{a:A}{q}}} 
\and 
  \inferrule*{ }
    {\judgeS{\mspec{p}{c}{a:A}{q} \specimp \spec{p}{\monad{c}}{a:A}{q}}} 
\and
...
\and
  ...
  \inferrule*
            {\judgeS{\mspec{p}{e}{x:A}{q}} \\
             \judgeS[\Delta,x:A]{\spec{q}{c}{a:B}{r}}}
            {\judgeS{\spec{p}{\letv{x}{e}{c}}{a:B}{r}}}
\and

  \inferrule*
            {\judgeS{(\forall x:\monad{A}.\; \mspec{p}x{a:A}{q(a)} \specimp \mspec{p}{e}{a:A}{q})}}
            {\judgeS{\mspec{p}{\fix{x:\monad{A}}{e}}{a:A}{q}}}
\and

  \inferrule*{\judgeS{\setof{r} \specimp \spec{p}{c}{a:A}{q}} \\
              \mbox{$r$ is a pure formula} \\
              \entailsP{\Delta}{p}{r}}
             {\judgeS{\spec{p}{c}{a:A}{q}}}
\and

  \inferrule*{\judgeS{\setof{r} \specimp \spec{p \land r}{c}{a:A}{q}}}
             {\judgeS{\setof{r} \specimp \spec{p}{c}{a:A}{q}}}
\and

  \inferrule*{ }
             {\judgeS{\setof{\validprop{S}} \specimp S}}
\and

  \inferrule*{\judgeS{\spec{\exists u:\omega.\;p}{c}{a:A}{q}}}
             {\judgeS[\Delta, u:\omega]{\spec{p}{c}{a:A}{q}}}

\and

  \inferrule*{\judgeS{\spec{p}{c}{a:A}{q}} \\
              \judgeS{\spec{p'}{c}{a:A}{q'}}}
             {\judgeS{\spec{p \vee p'}{c}{a:A}{q \vee q'}}}

\end{mathpar}
\caption{Axioms of the Program Logic}
\label{spec-logic-axioms}
\end{figure}
