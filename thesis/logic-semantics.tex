...
\item Now we want to show if $D :: \judgeS[{\Delta, u:\omega, \Delta'}]{S}$, then
  ...
  \item Case \textsc{SpecTriple}: 
    \begin{tabbedproof}
      ...
      \oooo $\interp{D_2}(\delta, \interp{D_0}, \delta') = \interp{D''_3}(\delta, \delta')$\\
      \ooo Where \\ 
      \oooo $D''_1 :: \judgeA[{\Delta, [p/u]\Delta'}]{[p/u]q}{\assert}$ \\                  
      ...
      \ooo By inversion on $D_2$, we have \\
      \oooo $D_4 :: \judgeE[\restrictkind{\Delta,u:\kappa,\Delta'}]
                           {\restricttype{\Delta,u:\kappa,\Delta'}}{\comp{c}}{\monad{A}}$ \\
      \ooo By inversion on $D'_2$, we have \\
      \oooo $D'_4 :: \judgeE[\restrictkind{\Delta,[p/u]\Delta'}]
                           {\restricttype{\Delta,[p/u]\Delta'}}{[p/u]\comp{c}}{[p/u](\monad{A})}$ \\
      \ooo By semantics, $\interp{D}(\delta, \interp{D_0}, \delta') = \interp{D'}(\delta, \delta')$ \\
      \oooo let $P = \interp{D_1}(\delta, \interp{D_0}\delta, \delta')$ \\
