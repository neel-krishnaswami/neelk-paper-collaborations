...
\begin{figure}[h]
\begin{mathpar}
  \inferrule*{\judgeS{\spec{p}{c}{a:A}{q} \specimp \mspec{p}{\comp{c}}{a:A}{q}}} 
...
\and
  ...
  \inferrule*{\validS{\setof{r} \specimp \spec{p}{c}{a:A}{q}} \\
              \mbox{$r$ is a pure formula} \\
              \validP{p \implies r}}
             {\validS{\spec{p}{c}{a:A}{q}}}
\and

  \inferrule*{\validS{\setof{r} \specimp \spec{p \land r}{c}{a:A}{q}}}
...
\and
  ...
  \inferrule*{\validS[\Delta, u:\omega]{\spec{p}{c}{a:A}{q}}}
             {\validS{\spec{\exists u:\omega.\;p}{c}{a:A}{q}}}
\and
  \inferrule*{\validS{\spec{p'}{c}{a:A}{q'}} \\ \validP{p \implies p'} \\ \validP{q' \implies q}}
             {\validS{\spec{p}{c}{a:A}{q}}}
  
\and

  \inferrule*{\validS{\spec{p}{c}{a:A}{q}} \\
              \validS{\spec{p'}{c}{a:A}{q'}}}
...
equalities. In Figure~\ref{spec-logic-axioms}, I give the rules for
deriving valid specifications. In Figure~\ref{assertion-logic-axioms},
I give some of the rules for deriving valid assertions, and in
Figure~\ref{assertion-equality}, I give rules for deriving equalities
between terms.

In Figures \ref{spec-logic-axioms} and \ref{assertion-logic-axioms}, I
do not give a complete list of the axioms: in particular, I have not
given axioms corresponding to the axioms of intuitionistic logic or
separation logic. The soundness of these axioms is immediate from the
semantics, and instead I have focused on the distinctive rules of the
program logic.
