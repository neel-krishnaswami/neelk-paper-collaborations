...
\boxed{\judgeACtx{\Delta}}
\\
\inferrule*[right=SortCtxNil]
          { } 
          {\judgeACtx{\cdot}}
\and 
\inferrule*[right=SortCtxCons]
          {\judgeACtx{\Delta} \\
           \judgeSort{\upsilon}}
          {\judgeACtx{\Delta, u:\upsilon}}
\\
...
\and
  ...
  \inferrule*[right=AxFix]
            {\validS{(\forall x:\monad{A}.\; \mspec{p}x{a:A}{q}) \specimp \mspec{p}{e}{a:A}{q})}}
...
\and
  \inferrule*[right=AxEquality]
             {\validS{\setof{r} \specimp \spec{p}{[e/x]c}{a:A}{q}} \\
              \validP{r \implies e =_A e'} }
             {\judgeS{\setof{r} \specimp \spec{p}{[e'/x]c}{a:A}{q}}}
