...
\item Iterators can be constructed from other iterators, and these
...
\nextline $\;\;\mergemath\;f\;xs\;xs' = \mergemath\;f\;xs_1\;xs_2 \land 
                                                    a = \Merge(f, i, i')\}$ 
\nextline $\setof{\exists i,i'.\; \iterpred_\gamma(\Merge(f, i, i'), \mergemath\;f\;xs\;xs', S \cup S') \wedge a = Merge(f,i,i')}$ 
...
\nextline \> \> \> $\{xs = z\cdot(\mathit{filter}\;p\;zs) \land \iterpred_\alpha(i', zs, S) * \mathit{colls}(S) \wedge v = Some(z)\}$
...
\nextline \> \> \> $[v],$
\nextline \> \> \> $\{a.\; \exists z, zs.\; xs = z\cdot zs \land a = \Some(z) \land \iterpred_\alpha(i, zs, S) * \mathit{colls}(S) \}$
\nextline \> \> \> $\{a.\;$\=$((a = \None \land xs = \epsilon \land \iterpred(i, xs, S)) \; \vee$ 
\nextline \> \> \>         \>$(\exists z, zs.\; a = \Some(z) \land xs = z\cdot zs \land \iterpred(i, zs, S))) \;*$ 
\nextline \> \> \>         \>$\mathit{colls}(S)\}$
...
$\One(i)$ case (lines 18-22). The iterator pointer is
...
\oo Hence $\mathit{list}(fs, \mathit{map}\;\snd{}\;os) * \mathit{obs\_at}(os, k)$
\end{tabbedproof}
\end{proof}
