...
\nextline \> \> \> $\{\exists xs'.\; xs = v\cdot xs' \land \iterpred_\alpha(\Filter(p, i'), xs', S) * \mathit{colls}(S)\}$
\nextline \> \> \> $\{\exists xs'.\; xs = v\cdot xs' \land \iterpred_\alpha(i, xs', S) * \mathit{colls}(S)\}$
\nextline \> \> \> $[v],$
\nextline \> \> \> $\{a.\; \exists x', xs'.\; xs = x'\cdot xs' \land a = \Some(x') \land \iterpred_\alpha(i, xs', S) * \mathit{colls}(S)\}$
\nextline \> \> \> $\{a.\;$\=$((a = \None \land xs = \epsilon \land \iterpred(i, xs, S)) \; \vee$ 
\nextline \> \> \>         \>$(\exists z, zs.\; a = \Some(z) \land xs = z\cdot zs \land \iterpred(i, zs, S))) \;*$ 
\nextline \> \> \>         \>$\mathit{colls}(S)\}$
\nextline \> \> \> Now, the else-branch:
\nextline \> \> \> $\{p\;z = \False \land ys = v\cdot zs \land \iterpred_\alpha(i', ys, S) * \mathit{colls}(S)\}$
...
\nextline \> \> \{$xs = \epsilon \land xs = \mathit{map2}\;f\;ys\;zs \land 
                  S = S_1 \uplus S_2 \land zs = \epsilon \;\land$ 
\\ \> \> \>\;\;    $(\exists bs.\; ys = b\cdot bs \land v_1 = \Some(b) \land 
                                \iterpred_\alpha(i_1, bs, S_1)) \;*$
\\ \> \> \>\;     $(zs = \epsilon \land v_2 = \None \land \iterpred_\alpha(i_2, zs, S_2))$ 
\\ \> \> \>\;     $\mathit{colls}(S)$\}
